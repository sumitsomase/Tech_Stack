...
function About() {
  return (
    <><div>
      ...
      <Helmet
        title="Teck Stack | About Us"
        description="Learn about Tech Stack, your trusted platform for developer learning paths and roadmaps."
        keywords="About Tech Stack, Developer Learning, Roadmaps" />
    </div><Box
      sx={{
        display: "flex",
